 ...
 */
@Data
@TableName("tg_callback_data")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="tg_callback_data对象", description="消息回调数据表")
public class TgCallbackData implements Serializable {
