...
/**
 * 处理代理机器人的"设置自动回复-消息按钮-删除"指令
 */
@Slf4j
@Service
public class DelAutoReplyBtnHandler extends BaseBotDataHandler {
    ...
    public void process(BaseBot botAgent, Update update) {
        ...
        if(config != null) {
            ...
            autoReplyConfigService.lambdaUpdate().set(TgAutoReplyConfig::getMsgButton, null).eq(TgAutoReplyConfig::getId, config.getId()).update();
        }
