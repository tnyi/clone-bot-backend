...
@Slf4j
@Service
public class SetBottomButtonTextHandler implements BaseBotMsgHandler {
    ...
    public void process(BaseBot botAgent, Update update) {
        ...
        BotUtil.setTxtRelyHandler(botAgent.getDbBotId(),  message.getChatId(), SetBottomButtonTextOKHandler.class);
