...
/**
 * 处理代理机器人的"设置欢迎语媒体文件-删除"指令
 */
@Slf4j
@Service
public class DelGroupWelcomeMediaHandler extends BaseBotDataHandler {
    ...
    public void process(BaseBot botAgent, Update update) {
        ...
        if(welcomeConfig != null) {
            ...
            welcomeConfigService.lambdaUpdate().set(TgWelcomeConfig::getMediaFile, null).eq(TgWelcomeConfig::getId, welcomeConfig.getId()).update();
