...
/**
 * 处理代理机器人的"设置欢迎语文本-删除"指令
 */
@Slf4j
@Service
public class DelGroupWelcomeTextHandler extends BaseBotDataHandler {
    ...
    public void process(BaseBot botAgent, Update update) {
        ...
        if(welcomeConfig != null) {
            welcomeConfig.setTextMsg(null);
            welcomeConfigService.lambdaUpdate().set(TgWelcomeConfig::getTextMsg, null).eq(TgWelcomeConfig::getId, welcomeConfig.getId()).update();
        }
