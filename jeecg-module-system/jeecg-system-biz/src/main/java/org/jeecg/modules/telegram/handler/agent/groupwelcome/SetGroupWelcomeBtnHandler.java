...
/**
 * 处理代理机器人的"设置欢迎语-设置按钮"指令
 */
@Slf4j
@Service
public class SetGroupWelcomeBtnHandler implements BaseBotMsgHandler {
    ...
    public void process(BaseBot botAgent, Update update) {
        ...
        BotUtil.setTxtRelyHandler(botAgent.getDbBotId(),  message.getChatId(), SetGroupWelcomeBtnOKHandler.class);
