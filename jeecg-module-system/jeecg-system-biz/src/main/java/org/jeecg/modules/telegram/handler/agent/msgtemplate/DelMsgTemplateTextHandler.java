...
/**
 * 处理代理机器人的"设置消息模板-文本-删除"指令
 */
@Slf4j
@Service
public class DelMsgTemplateTextHandler implements BaseBotMsgHandler {
    ...
    public void process(BaseBot botAgent, Update update) {
        ...
        if(config != null) {
            ...
            msgTemplateService.lambdaUpdate().set(TgMsgTemplate::getTextMsg, null).eq(TgMsgTemplate::getId, config.getId()).update();
        }
