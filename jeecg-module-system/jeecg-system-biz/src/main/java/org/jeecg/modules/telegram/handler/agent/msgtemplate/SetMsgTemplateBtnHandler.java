...
/**
 * 处理代理机器人的"设置消息模板-设置按钮"指令
 */
@Slf4j
@Service
public class SetMsgTemplateBtnHandler implements BaseBotMsgHandler {
    ...
    public void process(BaseBot botAgent, Update update) {
        ...
        BotUtil.setTxtRelyHandler(botAgent.getDbBotId(),  message.getChatId(), SetMsgTemplateBtnOKHandler.class);
