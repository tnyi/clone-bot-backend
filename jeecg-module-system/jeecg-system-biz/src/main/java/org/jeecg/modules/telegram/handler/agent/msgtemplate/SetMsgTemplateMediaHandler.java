...
/**
 * 处理代理机器人的"自动回复-媒体文件"指令
 */
@Slf4j
@Service
public class SetMsgTemplateMediaHandler implements BaseBotMsgHandler {
    ...
    public void process(BaseBot botAgent, Update update) {
        ...
        BotUtil.setTxtRelyHandler(botAgent.getDbBotId(),  message.getChatId(), SetMsgTemplateMediaOKHandler.class);
