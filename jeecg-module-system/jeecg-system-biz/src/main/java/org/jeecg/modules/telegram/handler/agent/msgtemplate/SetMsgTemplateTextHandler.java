...
/**
 * 处理代理机器人的"设置消息模板-某条目-设置文本"指令
 */
@Slf4j
@Service
public class SetMsgTemplateTextHandler implements BaseBotMsgHandler {
    ...
    public void process(BaseBot botAgent, Update update) {
        ...
        BotUtil.setTxtRelyHandler(botAgent.getDbBotId(),  message.getChatId(), SetMsgTemplateTextOKHandler.class);
