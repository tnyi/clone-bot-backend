...
/**
 * 处理代理机器人的"设置欢迎语-设置按钮-设置底部按钮"指令
 */
@Slf4j
@Service
public class SetWelcomeBottomBtnHandler implements BaseBotMsgHandler {

    @Override
    public void process(BaseBot botAgent, Update update) {
        String msg = "\uD83D\uDC49 请回复要添加的底部按钮，格式如下：\n" +
                        "\n" +
                        "<code>底部按钮1\n" +
                        "底部按钮2 | 底部按钮3\n" +
                        "底部按钮4</code>\n" +
        ...
        BotUtil.setTxtRelyHandler(botAgent.getDbBotId(),  message.getChatId(), SetWelcomeBottomBtnOKHandler.class);
