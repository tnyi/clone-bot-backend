...
@Slf4j
@Service
public class ViewWelcomeTextHandler extends BaseBotDataHandler {
    ...
    public void process(BaseBot botAgent, Update update) {
        TgWelcomeConfig tgWelcomeConfig = welcomeConfigService.getBotWelcomeByConfigId(getCallbackData(update));
